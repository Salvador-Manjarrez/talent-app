<x-layout>
    <x-page-heading> New Post - PROJECT <i class="fa-solid fa-list-check fa-xl m-5"></i> </x-page-heading>
    <hr>
    ...
    <p class=" text-center"><i class="fa-solid fa-circle-exclamation fa-xl m-5"> </i> Labels marked with <strong> * are required</strong></p>
        ...
        <x-panel>
            <x-forms.select label="Are you looking for / or offering this project? *" name="status" placeholder="Looking for? or Offering?">
